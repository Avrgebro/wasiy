...
function dashboard(withManagement: boolean): LocationDashboardResponse {
  return {
    ...
    today: {
      ...
      visitors_inside: [
        { id: 'vs_1', account_id: 'acc_1', location_id: 'loc_1', unit_id: 'un_1', unit_number: '1203', building_name: 'Torre 1', resident_id: null, resident_name: null, resident_phone: null, visitor_name: 'Jorge Peña', document: null, phone: null, confirmation: 'none', notes: null, status: 'inside', expected_on: null, expected_time: null, pre_registered_at: null, cancelled_at: null, checked_in_at: sixHoursAgo, checked_in_by_name: 'A. Quispe', checked_out_at: null, checked_out_by_name: null, checkout_notes: null, auto_checked_out: false, is_overdue: true },
        { id: 'vs_2', account_id: 'acc_1', location_id: 'loc_1', unit_id: 'un_2', unit_number: '402', building_name: 'Torre 1', resident_id: null, resident_name: null, resident_phone: null, visitor_name: 'Elena Vargas', document: null, phone: null, confirmation: 'intercom', notes: null, status: 'inside', expected_on: null, expected_time: null, pre_registered_at: null, cancelled_at: null, checked_in_at: halfHourAgo, checked_in_by_name: 'A. Quispe', checked_out_at: null, checked_out_by_name: null, checkout_notes: null, auto_checked_out: false, is_overdue: false },
      ],
    ...
    ...(withManagement
      ? {
          management: {
            month: '2026-09',
            dues_issued_total_minor: 2460000,
            dues_collected_total_minor: 1845000,
            units_with_balance_count: 14,
            deposits_held_total_minor: 120000,
