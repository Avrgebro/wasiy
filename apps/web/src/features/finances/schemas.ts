...
export const EXPENSE_CATEGORIES = ['utility', 'cleaning', 'maintenance', 'other'] as const
export const INCOME_CATEGORIES = ['reservation_fee', 'reservation_deposit', 'other'] as const
