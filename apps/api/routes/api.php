...
Route::middleware(['auth:sanctum', EnsureUserIsActive::class])->group(function () {
    ...
    Route::get('/portal/vehicles', [PortalVehicleController::class, 'index']);
    Route::post('/portal/vehicles', [PortalVehicleController::class, 'store']);
    Route::patch('/portal/vehicles/{vehicle}', [PortalVehicleController::class, 'update']);
    Route::delete('/portal/vehicles/{vehicle}', [PortalVehicleController::class, 'destroy']);
