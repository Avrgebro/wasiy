...
return [
    ...
    'attributes'             => [
        // Wasiy fields. Kept at the top so lang:update leaves them alone.
        'access_notes'            => 'notas de acceso',
        'account_role'            => 'rol de cuenta',
        'address_line1'           => 'dirección',
        'address_line2'           => 'referencia de dirección',
        'amenity_id'              => 'amenidad',
        'amount_minor'            => 'monto',
        'body_md'                 => 'contenido',
        'booking_mode'            => 'modo de aprobación',
        'building_id'             => 'torre',
        'category'                => 'categoría',
        'confirmation'            => 'confirmación',
        'contact_email'           => 'correo operativo',
        'counterparty'            => 'proveedor',
        'daily_capacity'          => 'capacidad diaria',
        'deposit_amount_minor'    => 'depósito',
        'detail'                  => 'detalle',
        'direction'               => 'tipo',
        'document'                => 'documento',
        'due_on'                  => 'vencimiento',
        'ended_at'                => 'fecha de salida',
        'expected_on'             => 'fecha esperada',
        'expected_time'           => 'hora esperada',
        'expires_on'              => 'fecha de vencimiento',
        'fee_amount_minor'        => 'cuota',
        'floor'                   => 'piso',
        'is_primary_contact'      => 'contacto principal',
        'is_reservable'           => 'reservable',
        'location_assignments'    => 'asignaciones por ubicación',
        'location_id'             => 'ubicación',
        'maintenance_fee_minor'   => 'cuota de mantenimiento',
        'make'                    => 'marca',
        'memberships'             => 'residentes',
        'model'                   => 'modelo',
        'note'                    => 'nota',
        'occurred_on'             => 'fecha',
        'open_days'               => 'días de apertura',
        'operation_number'        => 'número de operación',
        'paid_on'                 => 'fecha de pago',
        'parking_spots'           => 'estacionamientos',
        'participation_share'     => 'porcentaje de participación',
        'plate'                   => 'placa',
        'publish_at'              => 'fecha de publicación',
        'quiet_hours_end'         => 'fin del horario de silencio',
        'quiet_hours_start'       => 'inicio del horario de silencio',
        'reserved_on'             => 'día de la reserva',
        'resident_id'             => 'residente',
        'resident_type'           => 'tipo de residente',
        'sort_order'              => 'orden',
        'storage_rooms'           => 'depósitos',
        'terms_accepted'          => 'términos y condiciones',
        'unit_id'                 => 'unidad',
        'unit_number'             => 'número de unidad',
        'unit_price_minor'        => 'precio por unidad',
        'units'                   => 'unidades',
        'vehicle_type'            => 'tipo de vehículo',
        'visitor_auto_checkout_hours' => 'horas para cierre automático de visitas',
