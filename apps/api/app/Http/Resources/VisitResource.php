...
class VisitResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'expected_time' => $this->expected_time ? substr((string) $this->expected_time, 0, 5) : null,
            'pre_registered_by_name' => $this->whenLoaded('preRegisteredBy', fn () => $this->preRegisteredBy?->name),
            'pre_registered_at' => $this->pre_registered_at?->toJSON(),
