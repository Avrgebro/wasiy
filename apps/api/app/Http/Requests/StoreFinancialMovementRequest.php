...
class StoreFinancialMovementRequest extends FormRequest
{
    ...
    /**
     * The initial status must fit the category: a deposit starts pending or
     * held, everything else pending or paid.
     */
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            if (! in_array($status, MovementStatus::initialFor($category), true)) {
